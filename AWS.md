...
## 26. In CloudWatch, what is the use of log groups and Cloud trails?
...
## 27. What is the purpose of creating S3 bucket policies?
...
## 28. How do you maintain the lifecycle of an S3 bucket?
...
## 29. What are Network ACLs and Security Groups, and how do they differ?
...
## 30. How do you configure AWS RDS, and what factors do you consider (size, requirements, etc.)?
...
## 31. How much data is stored in your RDS MySQL?
In production, our largest database holds approximately 150 GB of transactional data.

## 32. How many masters and slaves are in RDS?
...
## 33. How comfortable with AWS and how much rate urself out of 5?
...
## 35. What is log rotate job and how does it work
...
## 37. How to login VM if VM has private IP
...
## 38. Types of load balancers
1. ALB
2. NLB
3. GWLB

## 39. How many NAT Gateways are needed for two public & two private subnets n a single VPC? Min & max?
...
## 40. Explain TTL in DNS- how does it work, and when do we use it? Explain the Flow.
...
## 41. How does weighted routing work in LB?
...
## 42. How does SSL work (Certbot, Let's Encrypt, AWS)? Explain the Flow.
...
## 43. diff between IAM Users and Roles
...
## 44. Can you avoid the specific port traffic using SGs?
...
## 45. What are the best password security practices used by your organisation?
...
## 46. What are the security parameters we must consider while we are creating an EC2 instance for production?
...
## 47. How can you protect the data in an AWS instance?
...
## 48. How can you connect from AWS to on-prem servers?

## 49. Explain about the transit gateway and why do we use this?
    AWS Transit Gateway
...
## 50. I have created an EC2 instance named A, and I want to create another instance B. It should create an instance without deleting instance A. What can I do during this?
...
## 51. How does the GSLB load balancer work?
...
## 52. Can we connect two different VM that are in a different Vnet.
...
## 55. Difference between S3 and EBS
...
## 56. What is the difference between vertical and horizontal scaling?
...
## 58. How do you did cost optimization in AWS?
...
## 59. How do you implement best security policies on AWS?
...
## 60. how many types of policy, IAM policy are there? IAM policies?
...
## 61. what is the difference between the S3 bucket policies and acls?
...
## 63. what is cloud watch uses cases.
...
## 64. what is limitations of lamda
...
## 67. how you ensure the best possible security for high availability architectures for 3 tier applications.
...
## 67. I'm an admin but I don't have access to the S3 bucket ? 
...
## 68. What are the top 5 infra attacks, and how do you mitigate them?- notAnswered

## 69. EC2 instance is unreachable, and it's not a security group issue. What's your next step?
...
## 70. An S3 bucket was made public by mistake. How do you secure and audit it?
...
## 71. RDS migration with minimal downtime – how would you approach it?
...
## 72. How would you set up networking in vpc
🔹 1. Create a VPC
...
## 73. How you will direct traffic to and from a instance in private subnet
...
## 74. how did you managed security for application level? 
...
## 75. What types of nodes did you deploy in AWS?
...
## 76. What is the difference between Interface Endpoint and Gateway Endpoint?
...
## 77. How did you set up ECS using EC2 instances?
...
## 78. Can't we configure Route 53?
...
## 79. If we want to configure third-party domains like GoDaddy in Route 53, how do we do that?
...
## 80. What is the difference between AWS Config and AWS CloudTrail?
...
## 81. What are the node groups you used in AWS EKS?
...
## 82. What are the types of node groups in AWS EKS?
...
## 83. If a user wants to access the S3 bucket, what are the processes?
...
## 85. How does Transit Gateway work and how did you configure it?
...
## 86. If we connect VPCs to the Transit Gateway, what will you update in the VPC Route Table?
...
## 87. For all VPCs, will you configure the Transit Gateway attachment with CIDR range?
...
## 88. What is WAF (Web Application Firewall) and AAF (Application Access Firewall)?
...
## 89. What is VPC Flow Logs and how will you track the IPs hitting the VPC?
...
## 90. How to filter a particular IP from AWS CloudWatch Log Group?
To filter logs for a specific IP in AWS CloudWatch, I use Logs Insights with a regex filter on @message

## 91. If you are storing logs in S3 Bucket, how will you track that particular IP?
...
## 92. How do you take the backup of AWS Services?
...
## 93. I need to send a logs from EC2 to S3, create an automation part where we need to take the log file, check the CPU metrics and send an alarm through cloud watch to user's.
...
## 94. If thre is an instance we have security group and web application firewall enabled, DDOS attack enabled will it protect from Bot attack.
...
## 95. What is DNS Resolution. Suppose I have new system with no cache what happens in the background.Step by step process.
...
## 96. If you're migrating a monolithic application from on-prem to Cloud and the system has its local file system, which file system you will use in AWS.
...
## 97. How will you store all the configurations related to your monolithic app in Cloud,
...
## 98.How would you secure an EC2 instance against unauthorized SSH access?
...
## 99. You need to connect your DB running in private subnet, not using NAT gateway or NAT instance or bastion host, what are the other options,
...
## 102. what metrics is used to monitor ec2 instance cpu, memory in aws
...
## 103. Sending log files from EC2 to S3 – what are the steps?
...
## 104. Difference between subnet and NACL?
...
## 105. Difference between NAT Gateway and Internet Gateway.
...
## 108. How do you connect private subnet to the internet?
...
## 109. Design HA backend using AWS services.
